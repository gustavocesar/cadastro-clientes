...
public class CadastrarPessoaFisicaCommand : IRequest<ErrorOr<PessoaFisicaCommandResponse>>
{
    ...
    public static implicit operator PessoaFisica(CadastrarPessoaFisicaCommand command)
    {
