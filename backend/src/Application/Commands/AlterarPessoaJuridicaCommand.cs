...
public class AlterarPessoaJuridicaCommand : IRequest<ErrorOr<PessoaJuridicaCommandResponse>>
{
    ...
    public static implicit operator PessoaJuridica(AlterarPessoaJuridicaCommand request)
    {
